...
## 摘要
在动态开放世界环境中，自主智能体经常遇到新颖性，这阻碍了它们寻找实现目标计划的能力。具体而言，当机器人的规划领域缺乏使其能够与环境中新颖物体进行适当交互的算子（operators）时，传统的符号规划器无法生成计划。我们提出了一种神经符号架构，该架构集成了符号规划、强化学习和大语言模型 (LLM)，以学习如何处理新颖物体。特别是，我们利用 LLM 的常识推理能力来识别缺失的算子，使用符号 AI 规划器生成计划，并编写奖励函数以引导强化学习智能体学习新识别算子的控制策略。我们的方法在连续机器人领域的算子发现和算子学习方面均优于现有最先进的方法。
