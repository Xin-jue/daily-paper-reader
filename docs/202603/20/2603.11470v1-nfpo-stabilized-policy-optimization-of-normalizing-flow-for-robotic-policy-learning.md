...
tags: ["query:q2"]
score: 7.0
evidence: 机器人策略学习与多模态分布建模
tldr: 针对机器人强化学习中传统高斯策略难以建模多模态分布的问题，本文提出了一种基于归一化流（Normalizing Flow）的稳定策略优化方法 NFPO。通过深入分析 NF 在在线强化学习中训练不稳定的原因，研究者引入了简单有效的稳定化技术。实验表明，NFPO 在多种仿真环境和真实机器人任务中均表现出强健的性能，成功解决了复杂动作分布的建模难题并实现了真机迁移。
selection_source: fresh_fetch
motivation: 传统的多元高斯策略无法有效建模机器人任务中的多模态分布，而归一化流虽具潜力但在线训练极不稳定。
method: 通过分析归一化流在强化学习中的不稳定现象，提出了一种简单而有效的稳定化技术来优化 NF 策略。
