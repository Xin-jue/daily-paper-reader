...
score: 6.0
evidence: 动态环境下具身智能体的能力演化
tldr: 针对具身智能体在长期运行中因频繁修改自身（如提示词或策略更新）导致身份丢失和不稳定的问题，本文提出一种以能力为中心的演化范式。通过引入具身能力模块（ECM），将能力演化与智能体身份解耦。该框架通过闭环学习不断优化模块，在大幅提升任务成功率的同时确保了系统的稳定性和安全性，为构建长效具身智能提供了新思路。
